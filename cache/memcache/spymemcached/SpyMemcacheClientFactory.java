...
import com.zhangwen.cache.memcache.Config;
import com.zhangwen.cache.memcache.Memcache;
import com.zhangwen.cache.memcache.MemcacheClientFactory;
import com.zhangwen.cache.memcache.PropertiesHelper;
...
public class SpyMemcacheClientFactory implements MemcacheClientFactory {
    ...
    public String getServerList() {
        return properties.get(PROP_SERVERS, "118.31.239.192:11211");
    }
    ...
    public String getConnectionFactoryName() {
        return properties.get(PROP_CONNECTION_FACTORY,
                BinaryConnectionFactory.class.getSimpleName());
    }
