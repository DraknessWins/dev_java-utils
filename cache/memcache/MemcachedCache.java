...
import com.zhangwen.cache.memcache.keystrategy.*;
...
public class MemcachedCache {
    ...
    private double dogpilePreventionExpirationFactor = 1;
    ...
    public void setDogpilePreventionExpirationFactor(double dogpilePreventionExpirationFactor) {
        if (dogpilePreventionExpirationFactor <= 1.0) {
            throw new IllegalArgumentException("dogpilePreventionExpirationFactor must be greater than or equal to 1.0");
        }
